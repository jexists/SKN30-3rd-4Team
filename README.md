...
### 김진남
> 벌써 3차 프로젝트 기간이 끝났다는게 시간이 빠르게 흘러가는 거 같다고 생각되었습니다. 접해보지 못한 도메인을 주제로 작업하는 것도 처음이고, RAG를 이용하는 것도 익숙하지 못해서인지 아쉬운 부분도 있었지만 팀원들이 도와주어 마무리할 수 있었습니다. 4차에 더 발전해서 더 좋은 결과를 낼 수 있도록 노력해야겠다 생각했습니다. 다들 고생하셨습니다. 감사합니다.
### 정민규
> 실제로 직장생활을 해보신 분들과 같이 팀을 해서 배울 점이 정말 많고 도움이 많이 된 프로젝트인 것 같습니다. 데이터 전처리 부분은 처음 맡아본 부분이라 익숙하지 않았지만 주변에서 많이 도와주신 덕분에 할 수 있었던 것 같습니다. 4차 프로젝트도 남았는데 고도화하며 어떤 결과가 나올지 더 기대가 됩니다. 수고 많으셨고 4차도 잘 부탁드립니다!!!
### 정주애
> RAG를 진행하면서 가장 궁금했던 부분은 데이터 수집 후 임베딩하는 과정이었는데, 여러 방식으로 직접 시도해볼 수 있어서 좋았습니다. 아직 부족한 부분도 많았지만, 좋은 팀원들을 만나 어려운 도메인임에도 함께 결과물을 만들어낼 수 있었던 것 같습니다. 전월세 계약 관련 도메인에 대해서도 더 고민해보고, 4차 프로젝트에서는 어떤 방식으로 고도화하면 더 좋은 결과를 낼 수 있을지 계속 고민해보겠습니다. 감사합니다.
### 천성배
> 벌써 3차프로젝트가 끝났다는게 다시 한번 시간은 참 빠르다라는 생각을 해봅니다. 다른 팀보다 인원이 1명 작은 상황에서도 짧은시간에 다들 최선을 다해서 결과물을 만든것에 대해 팀의 중요성을 다시 또 한번 느꼈습니다. 팀원 3분께서 여러모로 많이 도와주셔서 3차프로젝트도 무사히 잘 끝냅니다. 한달뒤 남은 4차프로젝트도 미리 틈날때마다 아이디어를 구상해서 도움이 될 수 있도록 하겠습니다. 모두들 수고 많으셨습니다 감사합니다^^
